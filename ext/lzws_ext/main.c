...
void Init_lzws_ext()
{
  ...
  rb_define_module_function(module, "_compress_io", RUBY_METHOD_FUNC(lzws_ext_compress_io), 3);
  rb_define_module_function(module, "_decompress_io", RUBY_METHOD_FUNC(lzws_ext_decompress_io), 3);
